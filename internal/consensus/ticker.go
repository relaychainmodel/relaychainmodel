...
func (t *timeoutTicker) timeoutRoutine() {
	...
	for {
		...
		case newti := <-t.tickChan:
			...
			t.Logger.Info(
				"yiiguo scheduled time reset",
				"old_height", ti.Height,
				"old_step", ti.Step,
				"old_round", ti.Round,
				"old_dur", ti.Duration,
				"new_height", newti.Height,
				"new_step", newti.Step,
				"new_round", newti.Round,
				"new_dur", newti.Duration,
			)
			ti = newti
			t.Logger.Debug("Scheduled timeout", "begin", ti.String())
